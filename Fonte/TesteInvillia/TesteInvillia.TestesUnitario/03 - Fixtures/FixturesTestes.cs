...
{
    public class FixturesTestes : IClassFixture<TestesUnitarioFixture>
    {
        #region Construtor
        ...
        public FixturesTestes(TestesUnitarioFixture fixture)
        {
            var _jogoInfra = fixture.ServiceProvider.GetRequiredService<IJogoInfra>();
            var _usuarioInfra = fixture.ServiceProvider.GetRequiredService<IUsuarioInfra>();
            var _logErroInfra = fixture.ServiceProvider.GetRequiredService<ILogErroInfra>();
            var _logErroDominio = new LogErroDominio(_logErroInfra);
            var _mapper = fixture.ServiceProvider.GetService<IMapper>();

            _jogoDominio = new JogoDominio(_jogoInfra, _logErroDominio, _mapper);
            _usuarioDominio = new UsuarioDominio(_usuarioInfra, _jogoInfra, _logErroDominio, _mapper);
        }
